...
#ifndef KLINEXP_SWIFT_H
#define KLINEXP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="KLineXP",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class NSCoder;

SWIFT_CLASS("_TtC7KLineXP14KLineChartView")
...
@interface KLineChartView (SWIFT_EXTENSION(KLineXP)) <UIGestureRecognizerDelegate>
...
SWIFT_CLASS("_TtC7KLineXP19KLineIndicatorsView")
...
SWIFT_CLASS("_TtC7KLineXP16KLinePainterView")
...
SWIFT_CLASS("_TtC7KLineXP15KLinePeriodView")
...
SWIFT_CLASS("_TtC7KLineXP12KLinePopover")
@interface KLinePopover : UIView
...
SWIFT_CLASS("_TtC7KLineXP16KLineRequestTool")
@interface KLineRequestTool : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC7KLineXP11SDKDemoView")
@interface SDKDemoView : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
