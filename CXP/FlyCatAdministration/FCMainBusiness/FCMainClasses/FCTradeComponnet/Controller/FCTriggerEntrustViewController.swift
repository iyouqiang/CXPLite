//
//  FCPlanEntrustViewController.swift
...
class FCTriggerEntrustViewController: UIViewController {

    let disposeBag = DisposeBag()
    let triggerTableView: UITableView = UITableView.init(frame: .zero, style: .plain)
    let FCContractProfitLossCellIdentifier = "FCContractProfitLossCell"
    ...
    func fetchHistoryEntrustOrders() {
        ...
        let historyApi = FCApi_trigger_history(symbol: symbolStr, tradingUnit: tradingUnit, startTime: startTime, endTime: endTime, triggerType: "Open", state: "", tradingAction: "")
    ...
    func fetchEntrustOrders () {
        ...
        let api = FCApi_trigger_pending_orders.init(symbol: symbolStr, tradingUnit: tradingUnit, triggerType: "Open")
...
extension FCTriggerEntrustViewController: JXSegmentedListContainerViewListDelegate {
...
extension FCTriggerEntrustViewController : UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: FCContractProfitLossCellIdentifier) as! FCContractProfitLossCell
        cell.loadTriggerEntrustData(model: self.entrustModels[indexPath.row])
