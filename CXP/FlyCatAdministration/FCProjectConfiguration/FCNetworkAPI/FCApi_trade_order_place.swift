...
class FCApi_trade_order_place: YTKRequest {
    /**
    ...
    var tradeType = ""
    var volumeType = ""
    var triggerClose = [String:Any]()
    
    init(symbol:String, tradingUnit: String, entrustVolume: String, entrustPrice: String, side: String, action: String, tradeType: String, volumeType: String, triggerClose: [String : Any] = [:]) {
        super.init()
        self.symbol = symbol
        ...
        self.triggerClose = triggerClose
    ...
    override func requestArgument() -> Any? {
        ...
        return ["symbol":symbol,
                ...
                "entrustVolume": ((entrustVolume ?? "") as NSString).floatValue,
                "entrustPrice" : ((entrustPrice ?? "") as NSString).floatValue,
                "side" : side,
                "action":action,
                "tradeType" : tradeType,
