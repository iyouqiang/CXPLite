...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/ZendeskAnswerBotProvidersSDK/AnswerBotProvidersSDK.framework"
  install_framework "${PODS_ROOT}/ZendeskAnswerBotSDK/AnswerBotSDK.framework"
  ...
  install_dsym "${PODS_ROOT}/ZendeskCoreSDK/ZendeskCoreSDK.framework.dSYM"
